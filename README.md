...
The [Specifications](https://github.com/franklihub/nrpc/wiki/Specifications) 
...
- the service definition [helloworld.proto](https://github.com/franklihub/nrpc/tree/master/examples/helloworld/helloworld/helloworld.proto)
- the generated nrpc go file [helloworld.nrpc.go](https://github.com/franklihub/nrpc/tree/master/examples/helloworld/helloworld/helloworld.nrpc.go)
- an example server [greeter_server/main.go](https://github.com/franklihub/nrpc/tree/master/examples/helloworld/greeter_server/main.go)
- an example client [greeter_client/main.go](https://github.com/franklihub/nrpc/tree/master/examples/helloworld/greeter_client/main.go)
...
- writing a main app that will connect to NATS and start the handler ([see
  example](https://github.com/franklihub/nrpc/blob/master/examples/helloworld/greeter_server/main.go))

To call the service:

- import the package that contains the generated *.nrpc.go files
- in the client code, connect to NATS
- create a Caller object and call the methods as necessary ([see example](https://github.com/franklihub/nrpc/blob/master/examples/helloworld/greeter_client/main.go))

## Features

The following wiki pages describe nRPC features in more detail:

- [Load Balancing](https://github.com/franklihub/nrpc/wiki/Load-Balancing)
- [Metrics Instrumentation](https://github.com/franklihub/nrpc/wiki/Metrics-Instrumentation)
  using Prometheus
...
```
$ go install github.com/franklihub/nrpc/examples/helloworld/greeter_server@latest
$ greeter_server
...
```
$ go install github.com/franklihub/nrpc/examples/helloworld/greeter_client@latest
$ greeter_client
